...
private:
    ...
    static int volumePercent(QPipeWireAudio::Source *source);
    void showOsd();
    ...
    QPipeWireAudio::SourceModel *m_sourceModel = nullptr; // microphone devices
    QPipeWireAudio::SourceOutputModel *m_sourceOutputModel = nullptr; // recording streams
